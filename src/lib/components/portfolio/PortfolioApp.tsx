...
export const PortfolioApp: React.FC<PortfolioAppProps> = ({
  ...
  <QueryProvider>
    <div className="min-h-screen bg-white text-primary-800">
      <a
        href="#contenido"
        className="sr-only fixed left-4 top-4 z-[60] rounded-lg bg-primary-900 px-4 py-2 text-sm font-medium text-white shadow-lg focus:not-sr-only"
      >
        Ir al contenido
      </a>

      <div className="sticky top-0 z-50 border-b border-primary-200 bg-white/95 backdrop-blur-md supports-[backdrop-filter]:bg-white/90">
      ...
      <footer className="border-t border-primary-200 bg-primary-50/60 py-8 sm:py-10">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 text-center sm:px-6 lg:px-8">
          <p className="text-sm font-medium text-primary-700">© {new Date().getFullYear()} Roger Cedeño</p>
