...
export const Hero: React.FC<HeroProps> = ({ personalInfo }) => (
  ...
  >
    <div
      aria-hidden="true"
      className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_18%_25%,rgba(37,99,235,0.18),transparent_32%),radial-gradient(circle_at_78%_32%,rgba(147,51,234,0.24),transparent_34%),linear-gradient(to_bottom,#020617,#030712)]"
    />
    <div
      aria-hidden="true"
    ...
    <div className="mx-auto grid max-w-6xl gap-12 px-4 pb-14 sm:px-6 sm:pb-20 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center lg:gap-16 lg:px-8 lg:pb-24">
      ...
      <aside className="relative mx-auto w-full max-w-[420px]" aria-label="Tarjeta profesional de Roger Cedeño">
        <div aria-hidden="true" className="absolute inset-8 rounded-full bg-gradient-to-br from-blue-500 via-violet-500 to-fuchsia-500 opacity-65 blur-3xl" />
        <div className="relative overflow-hidden rounded-[2rem] border border-violet-400/25 bg-slate-900/70 p-3 shadow-2xl shadow-violet-950/50 backdrop-blur-xl sm:p-4">
          <div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-slate-950">
            <div aria-hidden="true" className="absolute inset-[12%] rounded-full border-2 border-violet-400/70 shadow-[0_0_55px_rgba(124,58,237,0.55)]" />
            <img
              ...
              fetchPriority="high"
              decoding="async"
              className="relative z-10 aspect-[4/5] h-auto w-full object-cover object-top"
            />
          </div>

          <div className="relative -mt-12 mx-2 rounded-2xl border border-white/10 bg-slate-950/85 p-5 shadow-xl backdrop-blur-xl sm:mx-3">
